...
module.exports.cellar = function(req, res) {
  ...
  if (req.query.code) {
    ...
    request('https://untappd.com/oauth/authorize/?client_id=' + process.env.UTID + '&client_secret=' + process.env.UTSECRET + '&response_type=code&redirect_url=' + apiOptions.server + '/cellar&code=' + req.query.code,
